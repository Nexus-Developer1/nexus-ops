...
@php
    ...
    $icones = [
        ...
        'feeds' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6 5c7.18 0 13 5.82 13 13M6 11a7 7 0 017 7m-6 0a1 1 0 11-2 0 1 1 0 012 0z"/>',
    ];
    ...
    if ($u && $u->ehAdmin()) {
        ...
        $itens[] = ['id' => 'feeds', 'label' => 'Feeds da agenda', 'url' => route('agenda.feeds')];
    }
...
<aside class="bg-sidebar-grad fixed inset-y-0 left-0 z-40 flex h-screen w-sidebar shrink-0 flex-col px-5 py-7 transition-transform duration-200 ease-out -translate-x-full lg:sticky lg:top-0 lg:z-auto lg:translate-x-0"
    ...
    <div class="flex items-start justify-between px-2">
        <div>
            ...
            <div class="mt-2 text-[11px] font-medium uppercase tracking-[0.22em] text-white/40">Technical Suite</div>
        </div>
