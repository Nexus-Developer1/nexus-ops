<div class="flex min-h-screen items-center justify-center bg-white px-6 py-12">
    <div class="w-full max-w-sm">
        ...
        <form wire:submit="definir" class="mt-9 space-y-5">
            ...
            <div>
                <label class="campo-label" for="password">Palavra-passe</label>
            ...
            <button type="submit" class="botao-primario w-full py-3">
                <span wire:loading.remove wire:target="definir">Definir palavra-passe</span>
                <span wire:loading wire:target="definir">A guardar…</span>
            </button>
        </form>
