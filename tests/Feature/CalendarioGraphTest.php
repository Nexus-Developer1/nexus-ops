...
class CalendarioGraphTest extends TestCase
{
    ...
    public function test_criar_faz_post_com_tzid_e_guarda_o_id(): void
    {
        ...
        Http::assertSent(fn ($r) => $r->method() === 'POST'
            ...
            && $r['subject'] === 'PB · Preventiva UPS · ACME · Paulo Bento' // siglas · tipo · cliente · técnicos
    ...
    public function test_alterar_faz_patch_no_mesmo_id(): void
    {
        ...
        Http::assertSent(fn ($r) => $r->method() === 'PATCH' && str_ends_with($r->url(), '/events/EV-EXISTENTE') && $r['subject'] === 'PB · Corretiva · ACME · Paulo Bento');
