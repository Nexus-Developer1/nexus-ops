...
class FaturasAnuladasTest extends TestCase
{
    ...
    public function test_driver_real_le_o_anulado_da_ft(): void
    {
        ...
        Schema::connection('erp')->create('fi', function ($t) {
            $t->string('fistamp'); $t->string('ftstamp')->nullable(); $t->string('nmdoc')->nullable();
            $t->integer('fno')->nullable(); $t->string('ref')->nullable(); $t->string('design')->nullable();
            $t->string('series')->nullable(); $t->decimal('qtt')->nullable();
        });
        Schema::connection('erp')->create('ft', function ($t) {
            $t->string('ftstamp'); $t->date('fdata')->nullable(); $t->integer('no')->nullable();
    ...
    public function test_etiqueta_anulada_visivel_a_toda_a_equipa(): void
    {
        ...
        Livewire::actingAs($tecnico)->test(\App\Livewire\Clientes\Faturacao::class, ['cliente' => $cliente])
            ->assertSee('Anulada');

        Livewire::actingAs($tecnico)->test(\App\Livewire\Clientes\Fatura::class, ['cliente' => $cliente, 'linha' => $linha])
